...
export type ProductDetailsProps = React.HTMLAttributes<HTMLDivElement> & { data: any };

export const ProductDetails: React.FC<ProductDetailsProps> = ({ data, className, ...rest }) => {
