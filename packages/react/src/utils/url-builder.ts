...
export type Query = string | Partial<{ [key: string]: string | string[] | number | number[] | boolean }>;
...
export const getEndpoint = (url: string, params?: Params, query?: Query) => {
  return buildQuery(buildParams(url, params), query);
};
